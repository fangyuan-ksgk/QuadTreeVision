...
class RecurrentGatedResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, embed_dim=10,
        ...
        # Note that the control is uniformly applied to ALL LAYUERS
        # It upkeeps an Innate Hidden state, therefore the Recurrency here ! 
        if gate_type == 'rnn':
    ...
    def forward(self, x):
        ...
        # initial state also get propagated & updated
